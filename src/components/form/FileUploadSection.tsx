    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <Button
          variant="outline"
          size="icon"
          className="absolute -top-1 right-0 z-10 h-8 w-8 rounded-md bg-white border-gray-200 shadow-sm"
