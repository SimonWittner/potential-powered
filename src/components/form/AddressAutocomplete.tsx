    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverContent className="w-[calc(100vw-2rem)] sm:w-[var(--radix-popover-trigger-width)] p-0" align="start" sideOffset={4}>
            {loading ? (
              <div className="p-4 text-sm text-center">Loading suggestions...</div>
              ...
              <div className="p-4 text-sm text-center">Type at least 3 characters to search</div>
            )}
          </PopoverContent>
        </Popover>
      </div>
